    ...
    <>
      ...
      <main className="bg-white min-h-screen">
          ...
          <Container className="grid gap-12 lg:grid-cols-2 items-center">
            ...
            <Reveal delay={0.1}>
              <div className="relative group overflow-hidden border border-line shadow-hard">
                ...
                />
                <div className="absolute bottom-4 left-4 bg-brand-black/90 text-white font-mono text-sm uppercase tracking-wider px-3 py-1.5 border-l-2 border-brand-red">
        ...
        <section className="py-20 bg-surface-muted/50 border-b border-line">
          <Container>
            <Reveal>
              <span className="font-mono text-sm font-bold uppercase text-brand-blue tracking-[0.2em] block mb-3">Systems</span>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Reveal className="bg-white p-8 border border-line shadow-hard relative flex flex-col justify-between" delay={0.05}>
                <div>
                  ...
                  <ul className="mt-6 space-y-2.5 font-body text-sm text-ink-soft">
            ...
            <div className="mt-16 grid gap-12 lg:grid-cols-2 items-center bg-white border border-line p-8 lg:p-12 shadow-hard">
              <Reveal>
                <span className="font-mono text-sm font-bold uppercase text-brand-red tracking-[0.2em] block mb-3">Monitoring</span>
                ...
                <div className="mt-6 grid gap-6 sm:grid-cols-2">
                  <div className="border-t border-line pt-4">
                    <h4 className="font-mono text-sm font-bold uppercase tracking-wider text-brand-blue mb-2 flex items-center gap-1.5">
        ...
        <section className="py-20 border-b border-line">
          <Container>
            <Reveal>
              <span className="font-mono text-sm font-bold uppercase text-brand-blue tracking-[0.2em] block mb-3">Datasheet</span>
              ...
              <div className="overflow-x-auto border border-line shadow-hard">
                <table className="w-full text-left font-body text-sm border-collapse">
                  <thead>
                    <tr className="bg-brand-black text-white font-mono text-sm uppercase tracking-wider border-b border-line">
        ...
        <section className="py-20 bg-brand-black text-white">
          <Container>
            <Reveal>
              <span className="font-mono text-sm font-bold uppercase text-brand-red tracking-[0.2em] block mb-3">Lifecycle</span>
              ...
              {[
                ...
                return (
                  <Reveal key={step.title} delay={idx * 0.08} className="bg-white/5 p-6 border border-white/10 relative">
                    <span className="font-mono text-sm font-bold text-brand-red uppercase block mb-4">Phase 0{idx+1}</span>
                    ...
                    <p className="mt-3 font-body text-sm leading-relaxed text-white/60">{step.desc}</p>
                  </Reveal>
                )
              })}
            </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div className="border-l-2 border-brand-blue pl-4" key={ind.name}>
                    <h4 className="font-body text-sm font-bold text-ink">{ind.name}</h4>
                    <p className="font-body text-sm text-ink-soft mt-1 leading-relaxed">{ind.desc}</p>
                  </div>
                ))}
              </div>
            </Reveal>
              ...
              <div className="grid gap-4">
                {[
                  ...
                  <div className="bg-surface-muted p-5 border border-line" key={adv.title}>
                    <h4 className="font-mono text-sm font-bold uppercase tracking-wider text-brand-red">{adv.title}</h4>
                    <p className="font-body text-sm text-ink-soft mt-2 leading-relaxed">{adv.text}</p>
                  </div>
                ))}
              </div>
            </Reveal>
