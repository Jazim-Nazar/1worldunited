    ...
    <>
      ...
      <main className="bg-white min-h-screen">
        ...
        <section className="py-20 border-b border-line">
          <Container className="grid gap-12 lg:grid-cols-2 items-center">
            <Reveal>
              ...
              <div className="mt-8 bg-brand-blue/5 border-l-4 border-brand-blue p-5 font-body text-sm text-ink-soft leading-6">
            ...
            <Reveal delay={0.1}>
              <div className="relative border border-line shadow-hard overflow-hidden group">
                ...
                />
                <div className="absolute bottom-4 left-4 bg-brand-black/95 text-white font-mono text-sm uppercase tracking-wider px-3 py-1 border-l-2 border-brand-red">
        ...
        <section className="py-20 bg-surface-muted/30 border-b border-line">
          <Container>
            <Reveal className="text-center max-w-2xl mx-auto mb-16">
              <span className="font-mono text-sm font-bold uppercase text-brand-red tracking-[0.2em]">Ecosystem</span>
              <h2 className="font-display text-3xl sm:text-4xl uppercase text-ink mt-3">Three Dimensions of Radiant Comfort</h2>
              <p className="mt-4 font-body text-sm text-ink-muted leading-relaxed">
            ...
            <div className="grid gap-10 md:grid-cols-3">
              ...
              <Reveal className="bg-white border border-line p-6 shadow-hard flex flex-col justify-between" delay={0.05}>
                <div>
                  ...
                  <ul className="mt-5 space-y-2 font-body text-sm text-ink-soft pl-4 list-disc">
        ...
        <section className="py-20 border-b border-line">
          <Container>
            <Reveal>
              <span className="font-mono text-sm font-bold uppercase text-brand-blue tracking-[0.2em] block mb-3">Methods</span>
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                <div className="p-6 border border-line bg-surface-muted/40">
                  ...
                  <span className="font-mono text-sm text-brand-red uppercase block mb-3 font-bold">Screed-Based</span>
                  ...
                  <span className="font-mono text-sm text-ink-muted uppercase block font-semibold">Best For: New Builds, Villas</span>
                </div>

                <div className="p-6 border border-line bg-surface-muted/40">
                  <h4 className="font-display text-lg uppercase text-ink border-b border-line pb-2 mb-3">Dry Systems</h4>
                  <span className="font-mono text-sm text-brand-red uppercase block mb-3 font-bold">Screed-Free</span>
                  <p className="font-body text-sm text-ink-soft leading-relaxed mb-4">
                    Lightweight panels featuring integrated aluminum heat-distribution plates to ensure high speed thermal transfers.
                  </p>
                  <span className="font-mono text-sm text-ink-muted uppercase block font-semibold">Best For: Weight-limit builds, upper floors</span>
                </div>

                <div className="p-6 border border-line bg-surface-muted/40">
                  <h4 className="font-display text-lg uppercase text-ink border-b border-line pb-2 mb-3">Low-Profile</h4>
                  <span className="font-mono text-sm text-brand-red uppercase block mb-3 font-bold">Renovations</span>
                  <p className="font-body text-sm text-ink-soft leading-relaxed mb-4">
                    Ultra-thin panels designed for direct installation over existing substrates with minimal impact on floor heights.
                  </p>
                  <span className="font-mono text-sm text-ink-muted uppercase block font-semibold">Best For: Renovations, heritage sites</span>
                </div>

                <div className="p-6 border border-line bg-surface-muted/40">
                  <h4 className="font-display text-lg uppercase text-ink border-b border-line pb-2 mb-3">Modular Panels</h4>
                  <span className="font-mono text-sm text-brand-red uppercase block mb-3 font-bold">Drywall Panels</span>
                  <p className="font-body text-sm text-ink-soft leading-relaxed mb-4">
                    Prefabricated loops integrated into drywall assemblies for extremely quick installation inside walls or ceilings.
                  </p>
                  <span className="font-mono text-sm text-ink-muted uppercase block font-semibold">Best For: Fast-track interior fitouts</span>
                </div>
              </div>
            </Reveal>
          </Container>
        ...
        <section className="py-20 bg-brand-black text-white">
          <Container>
            <div className="grid gap-12 lg:grid-cols-[1fr_1.3fr] items-center">
              <Reveal>
                <span className="font-mono text-sm font-bold uppercase text-brand-red tracking-[0.2em] block mb-3">Automation</span>
                ...
                <div className="mt-8 flex gap-4 items-center">
                  <div className="text-center p-4 border border-white/10 bg-white/5 w-1/2">
                    ...
                    <span className="font-mono text-sm uppercase tracking-wider text-white/50 block mt-1">Silent Operation</span>
                  </div>
                  <div className="text-center p-4 border border-white/10 bg-white/5 w-1/2">
                    <span className="block font-display text-3xl text-brand-red">Up to 75%</span>
                    <span className="font-mono text-sm uppercase tracking-wider text-white/50 block mt-1">Energy Reduction</span>
                  </div>
                </div>
              </Reveal>
              ...
              <Reveal delay={0.1} className="grid gap-6 sm:grid-cols-2">
                <div className="p-6 border border-white/10 bg-white/5">
                  ...
                  <h4 className="font-mono text-sm font-bold uppercase tracking-wider text-white">Smart Environmental Monitoring</h4>
                ...
                <div className="p-6 border border-white/10 bg-white/5">
                  ...
                  <h4 className="font-mono text-sm font-bold uppercase tracking-wider text-white">Dew Point Condensation Safety</h4>
                  <p className="font-body text-sm text-white/60 leading-relaxed mt-2">
                ...
                <div className="p-6 border border-white/10 bg-white/5">
                  ...
                  <h4 className="font-mono text-sm font-bold uppercase tracking-wider text-white">Zoned Comfort Control</h4>
                  <p className="font-body text-sm text-white/60 leading-relaxed mt-2">
                ...
                <div className="p-6 border border-white/10 bg-white/5">
                  ...
                  <h4 className="font-mono text-sm font-bold uppercase tracking-wider text-white">BMS & Smart Integration</h4>
                  <p className="font-body text-sm text-white/60 leading-relaxed mt-2">
