  ...
  return (
    <section className="bg-brand-black text-white">
      <Container className="flex min-h-[330px] flex-col items-center justify-center py-24 text-center sm:min-h-[470px] sm:py-32 lg:min-h-[620px]">
        ...
        <Reveal delay={0.12}>
          <p className="mt-7 max-w-[520px] text-center font-body text-xs leading-5 text-white/80 sm:text-sm">
        ...
        <Reveal delay={0.22}>
          <div className="mt-20 flex flex-col items-center gap-4 sm:mt-28">
            <span className="font-mono text-[10px] font-bold uppercase tracking-[0.28em] text-white">Scroll To Explore</span>
